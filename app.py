...
# Initialize Binance client - NO API KEYS REQUIRED!
try:
    client = Client()  # Works without keys for public data!
    client.ping()
    logger.info("Binance client initialized successfully (public API)")
    ...
    try:
        ...
        <body style="font-family: Arial, sans-serif;">
            ...
            <table style="border-collapse: collapse;">
                <tr><td style="padding: 8px;"><b>Symbol:</b></td><td>{coin_data['symbol']}</td></tr>
                <tr><td style="padding: 8px;"><b>EMA Period:</b></td><td>{coin_data['ema_period']}</td></tr>
                <tr><td style="padding: 8px;"><b>Timeframe:</b></td><td>{coin_data['timeframe']}</td></tr>
                <tr><td style="padding: 8px;"><b>Price:</b></td><td>${coin_data['price']:,.4f}</td></tr>
                <tr><td style="padding: 8px;"><b>EMA:</b></td><td>${coin_data['ema']:,.4f}</td></tr>
                <tr><td style="padding: 8px;"><b>Distance:</b></td><td>{coin_data['distance_pct']}%</td></tr>
                <tr><td style="padding: 8px;"><b>Action:</b></td><td><b>{coin_data['crossed_above'] and '✅ CROSSED ABOVE' or coin_data['crossed_below'] and '📉 CROSSED BELOW' or f'⚠️ Within {coin_data["distance_pct"]}%'}</b></td></tr>
             </table>
            <p><a href="https://crypto-ema-monitor.onrender.com">View Dashboard</a></p>
        </body>
        </html>
        """
...
def get_top_cryptos():
    """Get top cryptocurrencies by volume (public API)"""
    if not client:
        return []
    try:
